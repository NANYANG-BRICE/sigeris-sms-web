...
return [
    ...
    'exact_length'          => 'Le champ {field} doit contenir {param} caractères.',
    ...
    'is_unique'             => 'Le champ {field} doit etre unique.',
    ...
    'matches'               => 'Différence entre les champs {field} et {param}.',
    ...
    // Files
    'uploaded' => 'Le fichier envoyé Le champ {field} n\'est pas valide.',
    'max_size' => 'Le fichier Le champ {field} est trop volumineux.',
    'is_image' => 'Le fichier envoyé Le champ {field} n\'est pas une image valide.',
    'mime_in'  => 'Le champ {field} n\'a pas un type MIME valide.',
    'ext_in'   => 'L\'extension du fichier Le champ {field}  n\'est pas valide.',
    'max_dims' => 'Soit Le champ {field} n\'est pas une image, soit elle est trop haute ou trop large.',
];
